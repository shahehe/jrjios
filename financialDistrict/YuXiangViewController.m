...
- (void)viewDidLoad
{
    ...
    yxcontentGPS = [[NSMutableArray alloc] init];
    ...
    for(NSDictionary* dic in yxInfoDicArray){
        ...
        [yxcontentGPS     addObject:[dic valueForKey:@"gps"]];
    }
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    textYXVC.gps = [self.yxcontentGPS objectAtIndex:indexPath.row];
